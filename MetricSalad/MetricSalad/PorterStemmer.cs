...
namespace MetricSalad
{
    ...
    */
    ...
    /**
      ...
      * word is provided by calling one of the various stem(something) methods.
      */
    ...
    public class PorterStemmer : StemmerInterface
    {
        ...
        /* Implementation of the .NET interface */
        ...
        */
        ...
        /* this is used when trying to restore an e at the end of a word 
         * ie. past(e), loath(e), bottl(e)
        */
        private bool cvd(int d)
        {
            if (m() == 1 && cons(0) && cons(d-2) && cons(d-1) && ends("e"))
                return true;
            else
                return false;
        }
        ...
        */
        ...
        private void step1()
        {
            if (ends("ches") || ends("shes"))
                k -= 2;
            else if (ends("ying"))
                if ((m() == 0) && cons(0) && !cons(1))
                    setto("i");
            if (b[k] == 's')
            {
                if (ends("sses"))
        ...
        /* step6() determines whether to remove a final -e */
        private void step6()
        {
            j = k;
